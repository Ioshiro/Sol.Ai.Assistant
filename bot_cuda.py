...
configure_pipecat_langfuse("bot-cuda")
...
async def run_bot(transport):
    ...
    logger.info("Creating Kokoro TTS...")
    tts = KokoroTTSService(
        voice_id=KOKORO_VOICE_ID,
        params=KokoroTTSService.InputParams(language=Language.IT),
    )
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Se l'input dell'utente è poco chiaro, chiedi una sola breve chiarificazione."
            ),
        }
    ]
